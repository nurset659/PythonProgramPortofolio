print("----------------- Program Kasir Sederhana Kantin Durian Runtuh -----------------")
...
def fungsimakanan():
   ...
   global porsi
   global mkn
   print ("\n----------------- * MENU MAKANAN KANTIN DURIAN RUNTUH * -----------------")
   print("1. Nasi Goreng - Rp 15000")
   print("2. Soto - Rp 9000")
   print("3. Mie Ayam - Rp 11000")
   nomor=int(input("Masukan Pilihan(angka:1,2,3): "))
...
def fungsiminuman():
   ...
   global mnm
   global gelas
   print("\n-----------------  *MENU MINUMAN KANTIN DURIAN RUNTUH* -----------------")
